...
@section('content')
<div class="container">
    <h1 class="h4 mb-4">Tambah Warna</h1>
            ...
            <form action="{{ route('warna.store') }}" method="POST">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <select name="type" id="type" class="form-select" required>
                                <option value="papan" @selected(old('type', $type ?? 'papan') === 'papan')>Papan</option>
                                <option value="rak" @selected(old('type', $type ?? 'papan') === 'rak')>Rak</option>
                            </select>
                        </div>
                    </div>
                    <div class="col-md-6">
                ...
                <a href="{{ route('warna.index', ['type' => $type]) }}" class="btn btn-secondary">Kembali</a>
            </form>
                </div>
            </div>
</div>
